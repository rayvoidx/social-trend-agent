...
def run_news_trend_analysis(query: str, time_window: str = "7d", language: str = "ko", max_results: int = 20) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "total_items": len(result.get("normalized", [])),
            "metrics": result.get("metrics", {}),
            "report_preview": result.get("report_md", "")[:500] + "...",
...
def run_viral_video_analysis(
    ...
    try:
        ...
        return {
            ...
            "market": market,
            "platforms": platforms,
            "spikes_detected": viral_data.get("total_spikes", 0),
            "avg_growth_rate": viral_data.get("avg_growth_rate", 0),
            "top_videos": top_videos,
            "success_factors": analysis.get("success_factors", [])[:3],
