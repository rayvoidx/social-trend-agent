...
후킹 포인트 분석 (첫 3초):
- 질문형: "이거 알고 계셨나요?" - 호기심 자극
- 충격형: 예상치 못한 결과/비포애프터 먼저 보여주기
- 공감형: "저도 처음에는..." - 타겟과 연결
- 긴급형: "끝까지 보세요" - 이탈 방지
- 트렌드형: 유행 사운드/밈/챌린지 활용
- 숫자형: "3가지 방법", "5초 만에" - 명확한 가치

콘텐츠 포맷 분류:
1. 튜토리얼/하우투: 단계별 설명, 슬로우 버전, 자막 필수
2. 비포/애프터: 변화 대비, 결과 먼저 보여주기, 시각적 임팩트
3. 리액션/리뷰: 솔직한 반응, 비교 분석, 신뢰성
4. 스토리텔링: 기승전결, 반전, 감정 몰입
5. 챌린지/트렌드: 따라하기 쉬운 포맷, 창작 여지
6. ASMR/감성: 몰입감, 시각/청각 자극, 릴랙스
